...
const NAV = [
    ...
    { href: 'admin.factures.index', label: 'Factures', icon: CashIcon },
...
function SidebarContent({ onNavigate }) {
    return (
        <div className="flex h-full flex-col bg-gradient-to-b from-[#123a63] to-[#0b2743] text-white">
            <div className="flex flex-col items-center gap-2 border-b border-white/10 px-6 py-7">
                <Link href={route('admin.dashboard')} onClick={onNavigate} className="flex flex-col items-center gap-2">
                    <img src="/images/logo.png" alt="Es Senia School" className="h-14 w-14 rounded-2xl bg-white/95 object-contain p-1.5 shadow-lg" />
                    <span className="text-center text-sm font-semibold tracking-wide text-white">Es Senia School</span>
                </Link>
            </div>
