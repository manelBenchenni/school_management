...
export default function Edit({ teacher, matieres, assignedMatiereIds }) {
    const { data, setData, put, processing, errors } = useForm({
        first_name: teacher.first_name,
        last_name: teacher.last_name,
        email: teacher.user.email,
        phone: teacher.user.phone || '',
        matiere_ids: assignedMatiereIds,
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Edit Teacher</h2>}
        >
                    ...
                    <div className="bg-white p-6 shadow-sm sm:rounded-lg">
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-xs text-gray-400">Admin-controlled — can be changed anytime.</p>
